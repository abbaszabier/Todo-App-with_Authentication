  ...
  @endif
            ...
            <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2 pt-1 pb-1 d-inline">
                                                <div class="row justify-content-between text-center">
                                                    <div class="col-6">
                                                        {{-- <form action="{{ route('home.edit', $home->id) }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                    ...
                                                    <div class="col-6 sampah">
                                                        <form action="{{ route('destroy', $home->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                ...
                <div class="footer text-center mb-2">
                    <small style="color: #aaaaaa">Todo App v1.0</small>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-content justify-content-center" style="width: 500px">
                    ...
                    <div class="modal-body">
                        <div class="input-group mb-3 mt-3">
                            <input type="title" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="#" required autocomplete="title" autofocus>
                        </div>
                    </div>

...
var days = 1;
var expirationCache = new workbox_expiration__WEBPACK_IMPORTED_MODULE_3__.ExpirationPlugin({
  maxAgeSeconds: days * 24 * 60 * 60
});
var NEW_CACHE_VERSION = "v1.0.0";
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_0__.precacheAndRoute)([{'revision':'118ad1c7656e9b1feb9634a5ed494f76','url':'/js/app.js'},{'revision':'68b329da9893e34099c7d8ad5cb9c940','url':'css/app.css'}] || []);
var navigationRoute = new workbox_routing__WEBPACK_IMPORTED_MODULE_1__.NavigationRoute(new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.NetworkFirst({
  cacheName: "home-runtime-cache1",
  plugins: [expirationCache]
}), {
  allowlist: [// Login/Register Page
  new RegExp("/"), new RegExp("/register"), new RegExp("/home")],
  denylist: []
}); // Handle images:
...
var fontsRoute = new workbox_routing__WEBPACK_IMPORTED_MODULE_1__.Route(function (_ref) {
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(fontsRoute);
